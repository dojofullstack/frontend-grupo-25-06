    ...
    <>
      <div className="container w-full p-5 flex justify-center my-16 ">
        ...
        <div className="flex  flex-col w-6/12 gap-4">
            ...
            <h2 className="text-3xl font-bold">Registrar usuario</h2>
        ...
        <label className="input input-bordered flex items-center gap-2">
          ...
          <input type="text" className="grow" placeholder="INgresar Email"  value={email} onChange={(e) =>  setEmail(e.target.value) } />
        </label>
        <label className="input input-bordered flex items-center gap-2">
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <button className="btn btn-accent text-xl"  onClick={registerUser} >

             {loadingRegister && <span className="loading loading-spinner"></span> }
            Registrate
        </button>
